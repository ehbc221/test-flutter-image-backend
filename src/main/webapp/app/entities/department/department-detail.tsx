    ...
    <Row>
      <Col md="8">
        <h2 data-cy="departmentDetailsHeading">
          <Translate contentKey="testapiimageApp.department.detail.title">Department</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="testapiimageApp.department.location">Location</Translate>
          </dt>
