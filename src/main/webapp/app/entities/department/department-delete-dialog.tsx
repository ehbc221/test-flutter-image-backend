...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testapiimageApp.department.delete.question">
        <Translate contentKey="testapiimageApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
