  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="testapiimageApp.job.home.createOrEditLabel" data-cy="JobCreateUpdateHeading">
            <Translate contentKey="testapiimageApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('testapiimageApp.job.jobTitle')}
                id="job-jobTitle"
                name="jobTitle"
                data-cy="jobTitle"
                type="text"
              />
              <ValidatedField
                label={translate('testapiimageApp.job.minSalary')}
                id="job-minSalary"
                name="minSalary"
                data-cy="minSalary"
                type="text"
              />
              <ValidatedField
                label={translate('testapiimageApp.job.maxSalary')}
                id="job-maxSalary"
                name="maxSalary"
                data-cy="maxSalary"
                type="text"
              />
              <ValidatedField
                label={translate('testapiimageApp.job.startDate')}
                id="job-startDate"
                name="startDate"
                data-cy="startDate"
                type="date"
              />
              <ValidatedField
                label={translate('testapiimageApp.job.endDate')}
                id="job-endDate"
                name="endDate"
                data-cy="endDate"
                type="date"
              />
              <ValidatedField
                label={translate('testapiimageApp.job.task')}
                id="job-task"
                data-cy="task"
                type="select"
                multiple
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('testapiimageApp.job.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
