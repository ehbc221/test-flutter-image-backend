...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './demande.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEMANDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEMANDE actions', async () => {
      const expectedActions = [
        {
