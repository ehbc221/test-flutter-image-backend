  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="testapiimageApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="testapiimageApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('testapiimageApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('testapiimageApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('testapiimageApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('testapiimageApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('testapiimageApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('testapiimageApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('testapiimageApp.employee.commissionPct')}
              ...
              />
              <ValidatedField
                label={translate('testapiimageApp.employee.birthDate')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('testapiimageApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('testapiimageApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
