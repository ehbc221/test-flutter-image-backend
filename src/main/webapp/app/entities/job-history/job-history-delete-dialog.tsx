...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testapiimageApp.jobHistory.delete.question">
        <Translate contentKey="testapiimageApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
