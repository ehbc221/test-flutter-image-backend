  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="testapiimageApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="testapiimageApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('testapiimageApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('testapiimageApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('testapiimageApp.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('testapiimageApp.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="job"
                data-cy="job"
                label={translate('testapiimageApp.jobHistory.job')}
                type="select"
              >
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('testapiimageApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('testapiimageApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
