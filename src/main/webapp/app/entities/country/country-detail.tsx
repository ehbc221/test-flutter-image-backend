    ...
    <Row>
      <Col md="8">
        <h2 data-cy="countryDetailsHeading">
          <Translate contentKey="testapiimageApp.country.detail.title">Country</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="countryName">
              <Translate contentKey="testapiimageApp.country.countryName">Country Name</Translate>
            </span>
          </dt>
          <dd>{countryEntity.countryName}</dd>
          <dt>
            <Translate contentKey="testapiimageApp.country.region">Region</Translate>
          </dt>
