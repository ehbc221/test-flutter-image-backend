...
class JobResourceIT {
    ...
    @Test
    @Transactional
    void getAllJobsByStartDateIsEqualToSomething() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByStartDateIsInShouldWork() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByStartDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByStartDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByStartDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByStartDateIsLessThanSomething() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByStartDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByEndDateIsEqualToSomething() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByEndDateIsInShouldWork() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByEndDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByEndDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByEndDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByEndDateIsLessThanSomething() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    @Test
    @Transactional
    void getAllJobsByEndDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
    ...
    void partialUpdateJobWithPatch() throws Exception {
        ...
        partialUpdatedJob.minSalary(UPDATED_MIN_SALARY).endDate(UPDATED_END_DATE);
